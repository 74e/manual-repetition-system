...
<template>
  <div v-if="!cardFlipped" class="flashcard-side meaning-side">
    <div class="meaning">
      <div class="label">Word</div>
      <div class="kanji-meaning">{{ currentFlashcard.word }}</div>
    </div>

    <div class="onyomi">
      <div class="label">Kana</div>
      <div class="reading-list">{{ currentFlashcard.kana }}</div>
    </div>
  </div>

  <div v-else class="flashcard-side kanji-side">
    <div class="meaning">
